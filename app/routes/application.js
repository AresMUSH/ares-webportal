    ...
    loadModel: function() {
        ...
        .then( (response) => {
            ...
            if (response.token_expiry_warning) {
              this.get('flashMessages').warning(`Your login expires today (in ${response.token_expiry_warning}). You should log out and back in before that happens so you don't lose any work.'`, { timeout: 15000 });
            }
            return response;
        })
        .catch(() => {
